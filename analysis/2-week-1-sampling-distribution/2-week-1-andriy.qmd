...
A good way to display summary of continuous, unimodal variables is a boxplot, which relays similar information as histogram, but is more specific statistically.
...
[![Anatomy of a boxplot](https://r-graph-gallery.com/img/other/boxplot_explanation.png)](https://r-graph-gallery.com/boxplot.html)
